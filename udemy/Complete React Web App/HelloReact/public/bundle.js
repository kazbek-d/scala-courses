...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(Greeter, { name: firstName, message: 'Message from props' }), document.getElementById('app'));
	...
	var Greeter = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(GreeterForm, { onNewDate: this.handleNewDate })
	    );
	  }
	});
