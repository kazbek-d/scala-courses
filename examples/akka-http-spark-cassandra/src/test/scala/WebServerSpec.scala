...
//    val balance = JsonParser(response.getTextBody).convertTo[m.SalesData]
//    assert(balance.price === 23.15)
//   }
//
//  test("GetBalance") {
...
//    val balance2 = JsonParser(response2.getTextBody).convertTo[m.SalesData]
//    assert(balance2.price === 1.15)
//
//    unbind
//  }
