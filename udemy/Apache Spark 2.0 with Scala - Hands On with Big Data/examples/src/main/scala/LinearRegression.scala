...
object LinearRegressionRDD extends App {
  ...
  val trainingLines = sc.textFile("./src/main/resources/additional/regression.txt")
  ...
  val testingLines = sc.textFile("./src/main/resources/additional/regression.txt")
